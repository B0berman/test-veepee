...
@Singleton
@Component(modules = [AndroidSupportInjectionModule::class, FavoriteActivityModule::class, NetworkModule::class, MovieListActivityModule::class, DetailActivityModule::class, DatabaseModule::class])
