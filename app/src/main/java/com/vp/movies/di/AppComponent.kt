...
@Singleton
@Component(modules = [AndroidSupportInjectionModule::class, NetworkModule::class, DatabaseModule::class, MovieListActivityModule::class, DetailActivityModule::class])
