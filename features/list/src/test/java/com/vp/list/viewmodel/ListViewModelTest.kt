...
class ListViewModelTest {
    ...
    fun shouldReturnErrorState() { //given
        ...
        //then
        Assertions.assertThat<ListState>(listViewModel.observeMovies().value?.listState)
    ...
    @Test
    fun shouldReturnSucessState() { //given
        val searchService = Mockito.mock(SearchService::class.java)
        Mockito.`when`(
            searchService.search(
                ArgumentMatchers.anyString(),
        ...
        assertThat<ListState>(result).isEqualTo(ListState.LOADED)
    }
}