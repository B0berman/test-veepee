...
public class MovieListActivity extends AppCompatActivity implements HasSupportFragmentInjector {
    ...
    private static final String IS_SEARCH_VIEW = "is_search_view";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            ...
            lastSearch=savedInstanceState.getString(IS_SEARCH_VIEW, null);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        searchView.setQuery(lastSearch,searchViewExpanded);
    ...
    protected void onSaveInstanceState(Bundle outState) {
        ...
        outState.putString(IS_SEARCH_VIEW, searchView.getQuery().toString());
