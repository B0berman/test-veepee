...
public class MovieListActivity extends AppCompatActivity implements HasSupportFragmentInjector {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            ...
            searchViewContent = savedInstanceState.getString(SEARCH_VIEW_CONTENT);
        }
    }
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        inflater.inflate(R.menu.movie_activity_options_menu, menu);
    ...
    private ListFragment getListFragment() {
        return (ListFragment) getSupportFragmentManager().findFragmentByTag(ListFragment.TAG);
    }
    ...
    protected void onSaveInstanceState(Bundle outState) {
        ...
        outState.putString(SEARCH_VIEW_CONTENT, searchViewContent);
    }
