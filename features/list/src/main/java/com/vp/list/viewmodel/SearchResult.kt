...
class SearchResult private constructor(val items: List<Movie>, val totalResult: Int, val listState: ListState) {
    ...
    companion object {
        ...
        fun success(items: List<Movie>, totalResult: Int): SearchResult {
