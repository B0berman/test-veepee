...
public class ListAdapter extends RecyclerView.Adapter<ListAdapter.ListViewHolder> {
    ...
    private List<FavouriteItem> listItems = Collections.emptyList();
    ...
    public void onBindViewHolder(@NonNull ListViewHolder holder, int position) {
        FavouriteItem favouriteItem = listItems.get(position);

        if (favouriteItem.getPoster() != null && !NO_IMAGE.equals(favouriteItem.getPoster())) {
            final float density = holder.image.getResources().getDisplayMetrics().density;
            GlideApp
                    .with(holder.image)
                    .load(favouriteItem.getPoster())
    ...
    public void setItems(List<FavouriteItem> listItems) {
